...
public class TableTest {
    ...
    public void testGetRecordByPKWithInvalidTypeKey(){
        ...
        Record r = null;
        String msgExpected = new PrimaryKeyException(5, new InvalidDataTypeException(str, a2).getMessage()).getMessage();
        String msgGot = "";
        try{
    ...
    public void createAttributes(int pkidx, String[] c, Type[] t, ArrayList<Attribute> attr){
        for(int i = 0; i < c.length; i++){
            Attribute a = new Attribute(c[i], t[i], i == pkidx ? true : false, types[i] == Type.VARCHAR || t[i] == Type.CHAR ? 20 : 0);
            attr.add(a); 
        }
